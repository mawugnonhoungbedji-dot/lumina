...
export const Article = () => {
    ...
    useEffect(() => {
        if (!article || !article.content) {
            // If it's one of the old articles without content, or simple not found
            // We could redirect or show a placeholder. For now, if no content, let's just stay or handle.
        ...
        <div className="pt-40 pb-32 px-6 lg:px-12 bg-bg transition-colors duration-300">
            <div className="max-w-4xl mx-auto">
                <FadeIn>
                    ...
                    <h1 className="text-4xl lg:text-7xl font-black font-display text-ink mb-12 leading-[1.1] tracking-tight">
                        {article.title}
                    </h1>
                        ...
                        <div className="space-y-24">
                            {article.content.sections.map((section: any, idx: number) => (
                                <FadeIn key={idx} delay={0.1 * idx}>
                                    <div className="group">
                                        <h2 className="text-2xl lg:text-4xl font-bold font-display text-ink mb-8 group-hover:translate-x-2 transition-transform duration-500">
                                            {section.title}
                                        </h2>
                                        ...
                                        {section.action && (
                                            <div className="p-8 lg:p-10 rounded-apple-xl bg-card border border-border relative overflow-hidden">
                                                ...
                                                <p className="text-ink font-bold leading-relaxed italic">
                                                    "{section.action}"
                                                </p>
                                            </div>
                                        )}
                        ...
                        <FadeIn delay={0.5}>
                            <div className="py-20 border-t border-border mt-20">
                                ...
                                <div className="bg-card border border-border rounded-apple-xl p-12 lg:p-20 text-center relative overflow-hidden group">
                                    ...
                                    <h3 className="text-2xl lg:text-4xl font-black font-display text-ink mb-8">
                                        {t('portfolio.cta_similar')}
                                    </h3>
