    ...
    <>
      ...
      <section className="pt-40 lg:pt-56 pb-20 px-6 lg:px-12 bg-bg relative min-h-[90vh] flex items-center">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          ...
          <FadeIn instant>
            <h1 className="display mb-10 whitespace-pre-line text-center lg:text-left leading-[1.1] lg:leading-none">
              {t('hero.title')}
            </h1>
          </FadeIn>
          ...
          <FadeIn instant>
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6">
              ...
              <Link to="/projets" className="w-full lg:w-auto">
      ...
      <section id="services" className="py-40 px-6 lg:px-12 bg-sec-b transition-colors duration-300 relative">
        <div className="max-w-7xl mx-auto relative z-10">
          <FadeIn>
            ...
            <p className="lead mb-20 max-w-2xl text-center lg:text-left mx-auto lg:mx-0">
              {t('approach.subtitle')}
            </p>
          </FadeIn>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <FadeIn className="text-center lg:text-left">
              ...
              <p className="text-xl lg:text-2xl text-ink leading-relaxed font-medium mb-10">
                {t('studio.p1')}
              </p>
              <p className="text-ink/60 leading-relaxed text-[16px] mb-12">
                {t('studio.p2')}
              </p>
            ...
            <FadeIn delay={0.2} className="relative group">
              <div className="aspect-square rounded-apple-xl overflow-hidden border border-border bg-card flex items-center justify-center p-12 relative group shadow-2xl shadow-ink/5">
                ...
                <div className="relative z-10 flex flex-col items-center gap-4">
                  <span className="text-5xl lg:text-[80px] font-black font-display text-ink tracking-tighter select-none group-hover:scale-105 transition-transform duration-1000">
                    Lumina.
                  </span>
      ...
      <section className="py-32 px-6 lg:px-12">
        <div className="max-w-7xl mx-auto">
          <FadeIn className="bg-card border border-border rounded-apple-xl p-16 lg:p-28 text-center relative overflow-hidden group">
            ...
            <p className="text-ink/60 max-w-xl mx-auto text-[14px] lg:text-[17px] mb-11 font-medium">
            ...
            <div className="mt-12 flex justify-center lg:justify-center">
              <div className="inline-flex items-center gap-2 text-sm font-bold text-ink/40 hover:text-ink transition-colors group cursor-pointer">
                ...
                <a href={`mailto:${CONTACT_EMAIL}`} className="underline underline-offset-8">
                  {CONTACT_EMAIL}
                </a>
              </div>
            </div>
