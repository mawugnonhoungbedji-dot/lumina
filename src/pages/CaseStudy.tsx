        ...
        <div className="min-h-screen bg-bg pt-32 pb-24">
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12">
                ...
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start mb-32">
                    ...
                    >
                        <h1 className="text-5xl lg:text-8xl font-black font-display text-ink mb-8 tracking-tighter leading-[0.9]">
                            {project.title}
                        </h1>
                ...
                <div className="max-w-4xl mx-auto mb-32">
                    <div className="grid md:grid-cols-3 gap-16">
                        ...
                        >
                            <div>
                                <h3 className="text-2xl font-black text-ink mb-6 flex items-center gap-4">
                        ...
                        >
                            <div className="p-8 rounded-[40px] bg-ink text-bg">
                                ...
                                <p className="text-bg/60 text-sm mb-8 leading-relaxed">
                ...
                >
                    ...
                    >
                        <h2 className="text-4xl lg:text-8xl font-black font-display text-ink mb-12 tracking-tighter group-hover:scale-95 transition-transform duration-700">
                            {nextProject.title}
                        </h2>
